...
// FbLeadDistributionRule and FbLeadDistributionState associations
...
module.exports = {
    ...
    BroadcastFilter,Lead,LeadStage,LeadStatus,LeadReason,
    ...
    Campaign,
    RawFacebookLead,
    FacebookIntegration,FbLeadDistributionState,FbLeadDistributionRule
}